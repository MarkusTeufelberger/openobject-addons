...
class sale_order(osv.osv):
    ...
    _columns = {
        ...
        'external_sale_base_amount': fields.float( 'External Subtotal', digits=( 16, int( config[ 'price_accuracy' ] ) ), readonly=True, help='Total amount in external system or online shop if the order was imported.' ),
        'external_sale_tax_amount': fields.float( 'External Tax', digits=( 16, int( config[ 'price_accuracy' ] ) ), readonly=True, help='Tax Amount in external system or online shop if the order was imported.' ),
        'external_sale_total_amount': fields.float( 'External Total', digits=( 16, int( config[ 'price_accuracy' ] ) ), readonly=True, help='Total amount in external system or online shop if the order was imported.' ),
    }
...
class sale_order_line(osv.osv):
    ...
    _columns = {
        ...
        'external_tax_amount': fields.float('External Tax', digits=(16, int(config['price_accuracy'])), readonly=True, help='Tax Amount in external system or online shop if the order was imported.'),
        ...
        'external_tax_percent': fields.float('External Tax Percent', digits=(16, int(config['price_accuracy'])), readonly=True, help='Tax Percentage Applied in online shop.'),
        'external_base_original_price': fields.float('External Original Base Price', digits=(16, int(config['price_accuracy'])), readonly=True, help='Original Base Price in online shop.'),
        'external_base_tax_amount': fields.float('External Base Tax Amount', digits=(16, int(config['price_accuracy'])), readonly=True, help='Base Tax Amount in online shop.'),
    }
...
class account_invoice(osv.osv):
    ...
    _columns = {
        ...
        'external_sale_base_amount': fields.float( 'External Subtotal Invoiced', digits=( 16, int( config[ 'price_accuracy' ] ) ), readonly=True, help='Total amount in external system or online shop if the order was imported.' ),
        'external_sale_tax_amount': fields.float( 'External Tax Invoiced', digits=( 16, int( config[ 'price_accuracy' ] ) ), readonly=True, help='Tax Amount in external system or online shop if the order was imported.' ),
        'external_sale_total_amount': fields.float( 'External Total Invoiced', digits=( 16, int( config[ 'price_accuracy' ] ) ), readonly=True, help='Total amount in external system or online shop if the order was imported.' ),
    }
