...
class GeneralLedger(report_sxw.rml_parse):
    _name = 'report.account.general.ledger_cumulated'
    def set_context(self, objects, data, ids, report_type = None):
        ...
        super(GeneralLedger, self).set_context(objects, data, new_ids, report_type)

    def __init__(self, cr, uid, name, context):
        super(GeneralLedger, self).__init__(cr, uid, name, context=context)
        self.date_borne = {}
        ...
        self.localcontext.update( {
            ...
            'strip_name' : self.report_helper_instance.strip_name
        })
...
report_sxw.report_sxw('report.account.general.ledger_cumulated', 'account.account', 'addons/c2c_cumulated_finance_report/report/general_ledger.rml', parser=GeneralLedger, header=False)

report_sxw.report_sxw('report.account.general.ledger_landscape_cumulated', 'account.account', 'addons/c2c_cumulated_finance_report/report/general_ledger_landscape.rml', parser=GeneralLedger, header=False)