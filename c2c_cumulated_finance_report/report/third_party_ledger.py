# -*- encoding: utf-8 -*-
#  third_party_ledger.py
#  c2c_cumulated_finance_report
#  Created by Vrenaville modififed by Nicolas Bessi
...
#TODO report cahnges in the core, supress rml_parse part in the core
#rewrite general ledger and third party ledger in the core
#TODO remove inheritance of the four
...
class ThirdPartyLedger(report_sxw.rml_parse):
    
    _name="report.account.third_party_ledger_cumulated"
    
    def __init__(self, cr, uid, name, context):
        self.date_lst = []
        self.date_lst_string = ''
        super(ThirdPartyLedger, self).__init__(cr, uid, name, context=context)
        self.report_helper_instance = reportHelper.ReportHelper(self.pool, self.cr, self.uid)
        self.localcontext.update( {
            ...
            'comma_me' : self.report_helper_instance.comma_me,
            'helper': self.report_helper_instance
    ...
    def set_context(self, objects, data, ids, report_type = None):
        ...
        super(ThirdPartyLedger, self).set_context(objects, data, new_ids, report_type)
...
report_sxw.report_sxw('report.account.third_party_ledger_cumulated', 'res.partner',
        'addons/c2c_cumulated_finance_report/report/third_party_ledger.rml',parser=ThirdPartyLedger,
        header=False)

report_sxw.report_sxw('report.account.third_party_ledger_other_cumulated', 'res.partner',
        'addons/c2c_cumulated_finance_report/report/third_party_ledger_other.rml',parser=ThirdPartyLedger,
        header=False)
