...
class AccountPartnerBalanceWizard(osv.osv_memory):
    ...
    #_inherit = "account.common.balance.report" # no inherit on osv_memory in v5
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        """
        res = super(AccountPartnerBalanceWizard, self).default_get(cr, uid, fields, context=context)
...
#                res[field] = 'filter_no'
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False):
        res = super(AccountPartnerBalanceWizard, self).fields_view_get(cr, uid, view_id, view_type, context=context, toolbar=toolbar)
    ...
    def pre_print_report(self, cr, uid, ids, context=None):
        ...
        fields_to_read = ['account_ids', 'result_selection', 'partner_ids',
                          'display_account', 'date_from',  'date_to',
                          'fiscalyear_id', 'journal_ids', 'period_from',
                          'period_to',  'filter',  'chart_account_id',
                          'target_move']
