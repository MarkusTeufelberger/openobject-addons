...
<form string="Bank statements import Epassporte">
...
fields = {
    ...
    'config_id': {'string': 'Config', 'type': 'many2one', 'relation': 'account.payment.epassporte.import.config', 'required': True, },
}

result_form = """<?xml version="1.0"?>
<form string="Import ePassporte Payments">
    <field name="state"/>
    <newline/>
    <separator string="Import result of ePassporte payments:" colspan="6"/>
...
class import_epassporte(wizard.interface):
...
import_epassporte('account_payment_epassporte.import_epassporte')
