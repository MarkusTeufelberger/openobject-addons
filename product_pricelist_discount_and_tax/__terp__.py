...
##############################################################################
{
    ...
    NOTE: The purchase_discount module in 5.0-extra-addons doesn't work with
    this module because it was modified by a third party.
    Download https://code.launchpad.net/~gdukai/+junk/purchase_discount_v5_original
