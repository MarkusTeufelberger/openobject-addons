...
class stock_location(osv.osv):
    ...
    _columns = {
        ...
        'parent_partner_id': fields.related('location_id', 'partner_id', type='many2one', relation='res.partner', string='Partner of Parent Location', store=True),
...
class stock_picking(osv.osv):
    ...
    def _default_address_id(self, cr, uid, context={}):
        return context.get('address_id', False)
